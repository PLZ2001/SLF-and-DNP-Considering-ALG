...
from SLF_train_test import CNN
...
class stacking_CNN(nn.Module):
    def __init__(self, device) -> None:
        ...
        self.model_num = 4
        self.device = device
        self.cnn = [get_cnn("CNN_20230126_111239.path", device),
                    get_cnn("CNN_20230127_113556.path", device),
                    get_cnn("CNN_20230127_130320.path", device),
                    get_cnn("CNN_20230127_150645.path", device)]
        ...
        self.integrator2 = nn.Sequential(
            nn.Flatten(1, -1),
            # 4*12
            nn.Linear(48, 48),
            nn.GELU(),
