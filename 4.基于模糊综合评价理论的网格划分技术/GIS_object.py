...
class GISObject:
    ...
    def get_network(self):
        ...
        self.node_name_list = load_variable(r"D:\OneDrive\桌面\毕设\代码\计及负荷异常增长的空间负荷预测与配电网规划\4.基于双层优化的网格划分技术\node_name_list.list")
        self.graph = load_variable(r"D:\OneDrive\桌面\毕设\代码\计及负荷异常增长的空间负荷预测与配电网规划\4.基于双层优化的网格划分技术\graph.nx")
